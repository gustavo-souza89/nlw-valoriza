...
var CreateUserService = /** @class */ (function () {
    ...
    CreateUserService.prototype.execute = function (_a) {
        var name = _a.name, email = _a.email, _b = _a.admin, admin = _b === void 0 ? false : _b, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            var usersRepository, err, err, userAlreadyExists, err, passwordHash, user;
